...
| 9383 | Go Admin | Go admin service (v0.25.6+) |
| 9384 | Go HTTP | Go HTTP service (v0.25.6+) |
...
needed — upstream v0.25.6 still ships the broken `ragflow_deps:latest` for aarch64.
